...
export default function App() {
  const sremployeetoken = !localStorage.getItem("senioremployeetoken") && "";
  const [sremployeeToken, setSrEmployeeToken] = useState(sremployeetoken);
  ...
  return (
    <div className="App">
      <Header
        remployeeToken={sremployeeToken}
        setSrEmployeeToken={setSrEmployeeToken}
